 ...
 */
class Media extends \EP\EpapeterieBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EP\\EpapeterieBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'EP\\EpapeterieBundle\\Entity\\Media' . "\0" . 'path', '' . "\0" . 'EP\\EpapeterieBundle\\Entity\\Media' . "\0" . 'alt');
        }
