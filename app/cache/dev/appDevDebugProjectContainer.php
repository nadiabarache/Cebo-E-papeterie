...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'epapeterie', 'user' => 'root', 'password' => 'blender', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/EP/EpapeterieBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Pages/PagesBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Users/UtilisateurBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'EP\\EpapeterieBundle\\Entity');
        $c->addDriver($b, 'Pages\\PagesBundle\\Entity');
        $c->addDriver($b, 'Users\\UtilisateurBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('EPEpapetrieBundle' => 'EP\\EpapeterieBundle\\Entity', 'PagesPagesBundle' => 'Pages\\PagesBundle\\Entity', 'UsersUtilisateurBundle' => 'Users\\UtilisateurBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bfc7a40b8ab4d854a06245492202b97503b862c4caa26e72be2cbc0a4048d532');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Users\\UtilisateurBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Users\\UtilisateurBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Users\\UtilisateurBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Users\\UtilisateurBundle\\Entity\\Utilisateurs');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Users\\UtilisateurBundle\\Entity\\Utilisateurs');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EP\EpapeterieBundle\Twig\Extension\MontantTvaExtension A EP\EpapeterieBundle\Twig\Extension\MontantTvaExtension instance.
     */
    protected function getMontanttvaService()
    {
        return $this->services['montanttva'] = new \EP\EpapeterieBundle\Twig\Extension\MontantTvaExtension();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EP\EpapeterieBundle\Listener\RedirectionListener A EP\EpapeterieBundle\Listener\RedirectionListener instance.
     */
    protected function getRedirectionlistenerService()
    {
        return $this->services['redirectionlistener'] = new \EP\EpapeterieBundle\Listener\RedirectionListener($this, $this->get('session'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '558070ebb6dee', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EP\EpapeterieBundle\Services\GetReference A EP\EpapeterieBundle\Services\GetReference instance.
     */
    protected function getSetnewreferenceService()
    {
        return $this->services['setnewreference'] = new \EP\EpapeterieBundle\Services\GetReference($this->get('security.context'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/EP/EpapeterieBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Users/UtilisateurBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EP\EpapeterieBundle\Twig\Extension\TvaExtension A EP\EpapeterieBundle\Twig\Extension\TvaExtension instance.
     */
    protected function getTvaService()
    {
        return $this->services['tva'] = new \EP\EpapeterieBundle\Twig\Extension\TvaExtension();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('telephone', '01 49 29 47 00');
        $instance->addGlobal('fax', '02 35 00 00 00');
        $instance->addGlobal('adresse', '108 avenue de la république - Paris 75 011');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/EP/EpapeterieBundle/Resources/views'), 'EPEpapetrie');
        $instance->addPath(($this->targetDirs[3].'/src/Pages/PagesBundle/Resources/views'), 'PagesPages');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/Users/UtilisateurBundle/Resources/views'), 'UsersUtilisateur');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EPEpapetrieBundle' => 'EP\\EpapeterieBundle\\EPEpapetrieBundle',
                'PagesPagesBundle' => 'Pages\\PagesBundle\\PagesPagesBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'UsersUtilisateurBundle' => 'Users\\UtilisateurBundle\\UsersUtilisateurBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'epapeterie',
            'database_user' => 'root',
            'database_password' => 'blender',
            ...
            'fos_user.model.user.class' => 'Users\\UtilisateurBundle\\Entity\\Utilisateurs',
