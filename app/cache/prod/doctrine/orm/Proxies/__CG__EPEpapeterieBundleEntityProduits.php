 ...
 */
class Produits extends \EP\EpapeterieBundle\Entity\Produits implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EP\\EpapeterieBundle\\Entity\\Produits' . "\0" . 'id', '' . "\0" . 'EP\\EpapeterieBundle\\Entity\\Produits' . "\0" . 'image', '' . "\0" . 'EP\\EpapeterieBundle\\Entity\\Produits' . "\0" . 'categorie', '' . "\0" . 'EP\\EpapeterieBundle\\Entity\\Produits' . "\0" . 'tva', '' . "\0" . 'EP\\EpapeterieBundle\\Entity\\Produits' . "\0" . 'nom', '' . "\0" . 'EP\\EpapeterieBundle\\Entity\\Produits' . "\0" . 'description', '' . "\0" . 'EP\\EpapeterieBundle\\Entity\\Produits' . "\0" . 'prix', '' . "\0" . 'EP\\EpapeterieBundle\\Entity\\Produits' . "\0" . 'disponible');
        }
